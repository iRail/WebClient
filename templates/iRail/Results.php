...
<td><a href="http://maps.google.be/?saddr=<? echo $content["connection"][0]["departure"]["stationinfo"]["locationY"] . " ".$content["connection"][0]["departure"]["stationinfo"]["locationX"]; ?>&daddr=<? echo $content["connection"][0]["arrival"]["stationinfo"]["locationY"] . " ".$content["connection"][0]["arrival"]["stationinfo"]["locationX"]; ?>" target="_blank"><img border="0" class="icon" src="templates/iRail/img/map.png" width="20" height="20" alt="Local Map" title="Click for map" /></a>
</td>
